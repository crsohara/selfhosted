...
/usr/bin/curl -sS \
    ...
    --data "{\"attachments\":[{\"fallback\":\"<!channel> :white_check_mark: Download completed - $name\",\"color\":\"#36a64f\",\"pretext\":\"<!channel> :white_check_mark: Download completed - $name\",\"fields\":[{\"title\":\"Name\",\"value\":\"$name\",\"short\":false},{\"title\":\"Size\",\"value\":\"$size\",\"short\":false}],\"footer\":\"qBittorrent\",\"footer_icon\":\"https://i.imgur.com/rEWsu2c.png\",\"ts\":$ts}]}" \
    $slack_webhook
